<p align="center">
    ...
    <a href="https://travis-ci.org/KituraKommunity/BlueSocket">
    <img src="https://travis-ci.org/KituraKommunity/BlueSocket.svg?branch=master" alt="Build Status - Master">
    </a>
...
* [BlueSSLService](https://github.com/KituraKommunity/BlueSSLService.git) can be used to add **SSL/TLS** support.
...
```
	dependencies: [
		.Package(url: "https://github.com/KituraKommunity/BlueSocket.git", majorVersion: <majorVersion>, minor: <minor>)
	]
```
...
```
	github "KituraKommunity/BlueSocket" ~> <majorVersion>.<minor>
```
...
let package = Package(
	name: "EchoServer",
	dependencies: [
		.package(url: "https://github.com/KituraKommunity/BlueSocket.git", from:"1.0.8"),
	],
	targets: [
	.target(
		name: "EchoServer",
...
let package = Package(
	name: "EchoServer",
	dependencies: [
	.Package(url: "https://github.com/KituraKommunity/BlueSocket.git", majorVersion: 1, minor: 0),
	],
...
This library is licensed under Apache 2.0. Full license text is available in [LICENSE](https://github.com/KituraKommunity/BlueSocket/blob/master/LICENSE).
